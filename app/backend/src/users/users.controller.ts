import { Controller, Delete, Get, Patch, Request, Body, UseGuards } from "@nestjs/common";
...
export class UsersController {
	...
	@Patch('profile')
	async updateProfile(@Request() req, @Body() dto: UpdateProfileDto): Promise<void> {
		return this.usersService.updateProfile(req.user.id, dto);
	}

	@Patch('settings')
	async updateSettings(@Request() req, @Body() dto: UpdateSettingsDto): Promise<User> {
