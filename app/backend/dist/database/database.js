...
exports.insertGoogleUser = insertGoogleUser;
...
async function runDatabase(query, params = []) {
    try {
...
async function insertLocalUser(name, email, passwordHash) {
    const query = `
...
async function insertGoogleUser(name, email, picture) {
    const query = `
