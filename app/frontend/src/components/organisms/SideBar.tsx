...
export const SideBar = ({
    ...
    console.log("SideBar - onCreateRoom prop value:", onCreateRoom);
        ...
        <aside className="w-[30%] min-w-[320px] max-w-[420px] h-full flex flex-col border-r border-gray-200 bg-white z-20">
            <header className="h-16 bg-gray-100 flex items-center justify-between px-4 border-b border-gray-200 bg-white z-20 relative">
                ...
                <div className="flex gap-2 text-gray-500 items-center">
                    <button
                        onClick={() => {
                            console.log("Click detected in SideBar");
                            setIsCreateModalOpen(true);
                        }}
                        onMouseDown={(e) => {
                            console.log("MouseDown detected in SideBar");
                            e.stopPropagation();
                        }}
                        title="New Chat"
            ...
            <CreateChatModal
                ...
                onCreate={(name, inviteUserIds) => {
                    if (onCreateRoom) {
                        onCreateRoom(name, inviteUserIds);
                    }
                }}
            />
        </aside>
